    ...
    <div class="col-lg-12">
        <div class="col-sm-3">
            <ul class="nav nav-pills nav-stacked">
                <li><a href="https://twitter.com/yupecms" target="_blank"><?php echo Yii::t(
                            'default',
                            'Twitter'
                        ); ?></a>
                </li>
                ...
                <li><a href="http://yupe-project.ru/" target="_blank"><?php echo Yii::t('default', 'Our site'); ?></a></li>
            </ul>
        </div>
        <div class="col-sm-3">
            <ul class="nav nav-pills nav-stacked">
        ...
        <div class="col-sm-3">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="https://github.com/yupe/yupe/" target="_blank"><?php echo Yii::t(
                            'default',
                            'GitHub'
                        ); ?></a>
                </li>
        ...
        <div class="col-sm-3">
            <ul class="nav nav-pills nav-stacked">
                <li><a href="http://allframeworks.ru" target="_blank"><?php echo Yii::t(
                            'default',
                            'allframeworks'
                        ); ?></a>
                </li>
...
<div class="row">
    <div class="col-lg-12">
        <ul class="nav nav-pills nav-stacked">
            <li>© PortalsWay 2010 - <?php echo date('Y'); ?></li>
        </ul>
    </div>
</div>
